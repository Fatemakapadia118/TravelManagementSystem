...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run()
    {
        String[] text = new String[]{"Grand Hotel", "Ocean View Resort", "Mountain Lodge", "Sunset Beach Hotel", "City Center Inn", "Riverfront Plaza", "Lakeside Retreat", "Skyline Tower Hotel", "Tranquil Oasis", "Golden Sands Resort"};
    ...
    CheckHotels(){
        ...
        caption.setFont(new Font("Tamoha",Font.PLAIN,40));
        add(caption);
